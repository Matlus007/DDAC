...
namespace Week3_MVCFlowerShop.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        private readonly UserManager<Week3_MVCFlowerShopUser> _userManager;
        private readonly SignInManager<Week3_MVCFlowerShopUser> _signInManager;

        public IndexModel(
            UserManager<Week3_MVCFlowerShopUser> userManager,
            SignInManager<Week3_MVCFlowerShopUser> signInManager)
        {
        ...
        private async Task LoadAsync(Week3_MVCFlowerShopUser user)
        {
            ...
            // Read from the database table into the page form
